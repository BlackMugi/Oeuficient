...
< Navbar />
      ...
      <section className="px-10 py-12 grid md:grid-cols-2 gap-10 items-center bg-white">
        ...
        <div>
          ...
          <button
            className="mt-6 text-white px-8 py-3 rounded-full shadow transition text-2xl  font-bold"
...
>
  ...
  sur l'organisation et les objectifs de production.
      ...
      <p className="text-xs text-gray-400 mt-4">
        ...
        <button
          className="mt-10  text-white  rounded-full text-2xl font-bold w-[150px] h-[42px] transition"
          style={{ backgroundColor: PRIMARY }}
          onMouseEnter={(e) =>
            (e.currentTarget.style.backgroundColor = PRIMARY_DARK)
          }
