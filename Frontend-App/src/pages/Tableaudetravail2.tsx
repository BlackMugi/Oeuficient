  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="bg-white h-28 rounded-2xl shadow flex items-center justify-center"></div>
        <div className="bg-white h-28 rounded-2xl shadow flex items-center justify-center"></div>
        <div className="bg-white h-28 rounded-2xl shadow flex items-center justify-center"></div>
      </div>
      {/* FIN CARTES */}
            ...
            <table className="min-w-full text-left">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  <th className="px-6 py-4 text-left text-2xl font-bold text-black font-['Barlow_Condensed']">
                    Lot
                  </th>
                  <th className="px-6 py-4 text-left text-2xl font-bold text-black font-['Barlow_Condensed']">
                    Espèce
